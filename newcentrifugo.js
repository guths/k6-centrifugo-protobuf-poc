    ...
    centrifugal.centrifuge = (function() {
        ...
        centrifuge.protocol = (function() {
            ...
            protocol.Error = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IError=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Error} Error instance
                 */
                ...
                Error.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Error)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Error();
                    if (object.code != null)
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Error
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Error} message Error
            ...
            protocol.EmulationRequest = (function() {
                ...
                /**
                 * Creates a new EmulationRequest instance using the specified properties.
                 * @function create
                 * @memberof centrifugal.centrifuge.protocol.EmulationRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IEmulationRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.EmulationRequest} EmulationRequest instance
                 */
                EmulationRequest.create = function create(properties) {
                    return new EmulationRequest(properties);
                };
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                EmulationRequest.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                /**
                 * Creates an EmulationRequest message from a plain object. Also converts values to their respective internal types.
                 * @function fromObject
                 * @memberof centrifugal.centrifuge.protocol.EmulationRequest
                 * @static
                 * @param {Object.<string,*>} object Plain object
                 * @returns {centrifugal.centrifuge.protocol.EmulationRequest} EmulationRequest
                 */
                EmulationRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.EmulationRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.EmulationRequest();
                    if (object.node != null)
                ...
                /**
                 * Creates a plain object from an EmulationRequest message. Also converts values to other types if specified.
                 * @function toObject
                 * @memberof centrifugal.centrifuge.protocol.EmulationRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.EmulationRequest} message EmulationRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                EmulationRequest.toObject = function toObject(message, options) {
                    if (!options)
                        options = {};
                    let object = {};
                    if (options.defaults) {
                ...
                /**
                 * Converts this EmulationRequest to JSON.
                 * @function toJSON
                 * @memberof centrifugal.centrifuge.protocol.EmulationRequest
                 * @instance
                 * @returns {Object.<string,*>} JSON object
                 */
                EmulationRequest.prototype.toJSON = function toJSON() {
                    return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                };
            ...
            protocol.Command = (function() {
                 ...
                 * @property {centrifugal.centrifuge.protocol.IPresenceStatsRequest|null} [presenceStats] Command presenceStats
                 ...
                 * @property {centrifugal.centrifuge.protocol.ISubRefreshRequest|null} [subRefresh] Command subRefresh
                 */
                 ...
                 * @member {centrifugal.centrifuge.protocol.IPresenceStatsRequest|null|undefined} presenceStats
                 * @memberof centrifugal.centrifuge.protocol.Command
                 * @instance
                 */
                Command.prototype.presenceStats = null;
                ...
                /**
                 * Command subRefresh.
                 * @member {centrifugal.centrifuge.protocol.ISubRefreshRequest|null|undefined} subRefresh
                 * @memberof centrifugal.centrifuge.protocol.Command
                 * @instance
                 */
                Command.prototype.subRefresh = null;
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ICommand=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Command} Command instance
                 */
                ...
                Command.encode = function encode(message, writer) {
                    ...
                    if (message.presenceStats != null && Object.hasOwnProperty.call(message, "presenceStats"))
                        $root.centrifugal.centrifuge.protocol.PresenceStatsRequest.encode(message.presenceStats, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
                    ...
                    if (message.subRefresh != null && Object.hasOwnProperty.call(message, "subRefresh"))
                        $root.centrifugal.centrifuge.protocol.SubRefreshRequest.encode(message.subRefresh, writer.uint32(/* id 15, wireType 2 =*/122).fork()).ldelim();
                    return writer;
                };
                ...
                Command.decode = function decode(reader, length, error) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 9: {
                                message.presenceStats = $root.centrifugal.centrifuge.protocol.PresenceStatsRequest.decode(reader, reader.uint32());
                                break;
                            }
                        case 10: {
                        ...
                        case 15: {
                                message.subRefresh = $root.centrifugal.centrifuge.protocol.SubRefreshRequest.decode(reader, reader.uint32());
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                Command.verify = function verify(message) {
                    ...
                    if (message.presenceStats != null && message.hasOwnProperty("presenceStats")) {
                        let error = $root.centrifugal.centrifuge.protocol.PresenceStatsRequest.verify(message.presenceStats);
                        if (error)
                            return "presenceStats." + error;
                    }
                    ...
                    if (message.subRefresh != null && message.hasOwnProperty("subRefresh")) {
                        let error = $root.centrifugal.centrifuge.protocol.SubRefreshRequest.verify(message.subRefresh);
                        if (error)
                            return "subRefresh." + error;
                    }
                    return null;
                };
                ...
                Command.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Command)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Command();
                    if (object.id != null)
                        message.id = object.id >>> 0;
                    if (object.connect != null) {
                        if (typeof object.connect !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.connect: object expected");
                        message.connect = $root.centrifugal.centrifuge.protocol.ConnectRequest.fromObject(object.connect);
                    }
                    if (object.subscribe != null) {
                        if (typeof object.subscribe !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.subscribe: object expected");
                        message.subscribe = $root.centrifugal.centrifuge.protocol.SubscribeRequest.fromObject(object.subscribe);
                    }
                    if (object.unsubscribe != null) {
                        if (typeof object.unsubscribe !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.unsubscribe: object expected");
                        message.unsubscribe = $root.centrifugal.centrifuge.protocol.UnsubscribeRequest.fromObject(object.unsubscribe);
                    }
                    if (object.publish != null) {
                        if (typeof object.publish !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.publish: object expected");
                        message.publish = $root.centrifugal.centrifuge.protocol.PublishRequest.fromObject(object.publish);
                    }
                    if (object.presence != null) {
                        if (typeof object.presence !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.presence: object expected");
                        message.presence = $root.centrifugal.centrifuge.protocol.PresenceRequest.fromObject(object.presence);
                    }
                    if (object.presenceStats != null) {
                        if (typeof object.presenceStats !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.presenceStats: object expected");
                        message.presenceStats = $root.centrifugal.centrifuge.protocol.PresenceStatsRequest.fromObject(object.presenceStats);
                    }
                    if (object.history != null) {
                        if (typeof object.history !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.history: object expected");
                        message.history = $root.centrifugal.centrifuge.protocol.HistoryRequest.fromObject(object.history);
                    }
                    if (object.ping != null) {
                        if (typeof object.ping !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.ping: object expected");
                        message.ping = $root.centrifugal.centrifuge.protocol.PingRequest.fromObject(object.ping);
                    }
                    if (object.send != null) {
                        if (typeof object.send !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.send: object expected");
                        message.send = $root.centrifugal.centrifuge.protocol.SendRequest.fromObject(object.send);
                    }
                    if (object.rpc != null) {
                        if (typeof object.rpc !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.rpc: object expected");
                        message.rpc = $root.centrifugal.centrifuge.protocol.RPCRequest.fromObject(object.rpc);
                    }
                    if (object.refresh != null) {
                        if (typeof object.refresh !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.refresh: object expected");
                        message.refresh = $root.centrifugal.centrifuge.protocol.RefreshRequest.fromObject(object.refresh);
                    }
                    if (object.subRefresh != null) {
                        if (typeof object.subRefresh !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Command.subRefresh: object expected");
                        message.subRefresh = $root.centrifugal.centrifuge.protocol.SubRefreshRequest.fromObject(object.subRefresh);
                    }
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Command
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Command} message Command
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                Command.toObject = function toObject(message, options) {
                    ...
                    if (options.defaults) {
                        ...
                        object.presenceStats = null;
                        object.history = null;
                        object.ping = null;
                        object.send = null;
                        object.rpc = null;
                        object.refresh = null;
                        object.subRefresh = null;
                    }
                    if (message.id != null && message.hasOwnProperty("id"))
                        object.id = message.id;
                    if (message.connect != null && message.hasOwnProperty("connect"))
                        object.connect = $root.centrifugal.centrifuge.protocol.ConnectRequest.toObject(message.connect, options);
                    if (message.subscribe != null && message.hasOwnProperty("subscribe"))
                        object.subscribe = $root.centrifugal.centrifuge.protocol.SubscribeRequest.toObject(message.subscribe, options);
                    if (message.unsubscribe != null && message.hasOwnProperty("unsubscribe"))
                        object.unsubscribe = $root.centrifugal.centrifuge.protocol.UnsubscribeRequest.toObject(message.unsubscribe, options);
                    if (message.publish != null && message.hasOwnProperty("publish"))
                        object.publish = $root.centrifugal.centrifuge.protocol.PublishRequest.toObject(message.publish, options);
                    if (message.presence != null && message.hasOwnProperty("presence"))
                        object.presence = $root.centrifugal.centrifuge.protocol.PresenceRequest.toObject(message.presence, options);
                    if (message.presenceStats != null && message.hasOwnProperty("presenceStats"))
                        object.presenceStats = $root.centrifugal.centrifuge.protocol.PresenceStatsRequest.toObject(message.presenceStats, options);
                    if (message.history != null && message.hasOwnProperty("history"))
                        object.history = $root.centrifugal.centrifuge.protocol.HistoryRequest.toObject(message.history, options);
                    if (message.ping != null && message.hasOwnProperty("ping"))
                        object.ping = $root.centrifugal.centrifuge.protocol.PingRequest.toObject(message.ping, options);
                    if (message.send != null && message.hasOwnProperty("send"))
                        object.send = $root.centrifugal.centrifuge.protocol.SendRequest.toObject(message.send, options);
                    if (message.rpc != null && message.hasOwnProperty("rpc"))
                        object.rpc = $root.centrifugal.centrifuge.protocol.RPCRequest.toObject(message.rpc, options);
                    if (message.refresh != null && message.hasOwnProperty("refresh"))
                        object.refresh = $root.centrifugal.centrifuge.protocol.RefreshRequest.toObject(message.refresh, options);
                    if (message.subRefresh != null && message.hasOwnProperty("subRefresh"))
                        object.subRefresh = $root.centrifugal.centrifuge.protocol.SubRefreshRequest.toObject(message.subRefresh, options);
                    return object;
                };
            ...
            protocol.Reply = (function() {
                 ...
                 * @property {centrifugal.centrifuge.protocol.IPresenceStatsResult|null} [presenceStats] Reply presenceStats
                 ...
                 * @property {centrifugal.centrifuge.protocol.ISubRefreshResult|null} [subRefresh] Reply subRefresh
                 */
                ...
                /**
                 * Reply presenceStats.
                 * @member {centrifugal.centrifuge.protocol.IPresenceStatsResult|null|undefined} presenceStats
                 * @memberof centrifugal.centrifuge.protocol.Reply
                 * @instance
                 */
                Reply.prototype.presenceStats = null;
                ...
                /**
                 * Reply subRefresh.
                 * @member {centrifugal.centrifuge.protocol.ISubRefreshResult|null|undefined} subRefresh
                 * @memberof centrifugal.centrifuge.protocol.Reply
                 * @instance
                 */
                Reply.prototype.subRefresh = null;
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IReply=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Reply} Reply instance
                 */
                ...
                Reply.encode = function encode(message, writer) {
                    ...
                    if (message.presenceStats != null && Object.hasOwnProperty.call(message, "presenceStats"))
                        $root.centrifugal.centrifuge.protocol.PresenceStatsResult.encode(message.presenceStats, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
                    if (message.history != null && Object.hasOwnProperty.call(message, "history"))
                    ...
                    if (message.subRefresh != null && Object.hasOwnProperty.call(message, "subRefresh"))
                        $root.centrifugal.centrifuge.protocol.SubRefreshResult.encode(message.subRefresh, writer.uint32(/* id 15, wireType 2 =*/122).fork()).ldelim();
                    return writer;
                };
                ...
                Reply.decode = function decode(reader, length, error) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 10: {
                                message.presenceStats = $root.centrifugal.centrifuge.protocol.PresenceStatsResult.decode(reader, reader.uint32());
                                break;
                            }
                        case 11: {
                        ...
                        case 15: {
                                message.subRefresh = $root.centrifugal.centrifuge.protocol.SubRefreshResult.decode(reader, reader.uint32());
                                break;
                            }
                        default:
                            reader.skipType(tag & 7);
                ...
                Reply.verify = function verify(message) {
                    ...
                    if (message.presenceStats != null && message.hasOwnProperty("presenceStats")) {
                        let error = $root.centrifugal.centrifuge.protocol.PresenceStatsResult.verify(message.presenceStats);
                        if (error)
                            return "presenceStats." + error;
                    }
                    if (message.history != null && message.hasOwnProperty("history")) {
                    ...
                    if (message.subRefresh != null && message.hasOwnProperty("subRefresh")) {
                        let error = $root.centrifugal.centrifuge.protocol.SubRefreshResult.verify(message.subRefresh);
                        if (error)
                            return "subRefresh." + error;
                    }
                    return null;
                ...
                Reply.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Reply)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Reply();
                    if (object.id != null)
                        message.id = object.id >>> 0;
                    if (object.error != null) {
                        if (typeof object.error !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.error: object expected");
                        message.error = $root.centrifugal.centrifuge.protocol.Error.fromObject(object.error);
                    }
                    if (object.push != null) {
                        if (typeof object.push !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.push: object expected");
                        message.push = $root.centrifugal.centrifuge.protocol.Push.fromObject(object.push);
                    }
                    if (object.connect != null) {
                        if (typeof object.connect !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.connect: object expected");
                        message.connect = $root.centrifugal.centrifuge.protocol.ConnectResult.fromObject(object.connect);
                    }
                    if (object.subscribe != null) {
                        if (typeof object.subscribe !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.subscribe: object expected");
                        message.subscribe = $root.centrifugal.centrifuge.protocol.SubscribeResult.fromObject(object.subscribe);
                    }
                    if (object.unsubscribe != null) {
                        if (typeof object.unsubscribe !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.unsubscribe: object expected");
                        message.unsubscribe = $root.centrifugal.centrifuge.protocol.UnsubscribeResult.fromObject(object.unsubscribe);
                    }
                    if (object.publish != null) {
                        if (typeof object.publish !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.publish: object expected");
                        message.publish = $root.centrifugal.centrifuge.protocol.PublishResult.fromObject(object.publish);
                    }
                    if (object.presence != null) {
                        if (typeof object.presence !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.presence: object expected");
                        message.presence = $root.centrifugal.centrifuge.protocol.PresenceResult.fromObject(object.presence);
                    }
                    if (object.presenceStats != null) {
                        if (typeof object.presenceStats !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.presenceStats: object expected");
                        message.presenceStats = $root.centrifugal.centrifuge.protocol.PresenceStatsResult.fromObject(object.presenceStats);
                    }
                    if (object.history != null) {
                        if (typeof object.history !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.history: object expected");
                        message.history = $root.centrifugal.centrifuge.protocol.HistoryResult.fromObject(object.history);
                    }
                    if (object.ping != null) {
                        if (typeof object.ping !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.ping: object expected");
                        message.ping = $root.centrifugal.centrifuge.protocol.PingResult.fromObject(object.ping);
                    }
                    if (object.rpc != null) {
                        if (typeof object.rpc !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.rpc: object expected");
                        message.rpc = $root.centrifugal.centrifuge.protocol.RPCResult.fromObject(object.rpc);
                    }
                    if (object.refresh != null) {
                        if (typeof object.refresh !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.refresh: object expected");
                        message.refresh = $root.centrifugal.centrifuge.protocol.RefreshResult.fromObject(object.refresh);
                    }
                    if (object.subRefresh != null) {
                        if (typeof object.subRefresh !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Reply.subRefresh: object expected");
                        message.subRefresh = $root.centrifugal.centrifuge.protocol.SubRefreshResult.fromObject(object.subRefresh);
                    }
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Reply
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Reply} message Reply
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                Reply.toObject = function toObject(message, options) {
                    ...
                    if (message.id != null && message.hasOwnProperty("id"))
                        object.id = message.id;
                    if (message.error != null && message.hasOwnProperty("error"))
                        object.error = $root.centrifugal.centrifuge.protocol.Error.toObject(message.error, options);
                    if (message.push != null && message.hasOwnProperty("push"))
                        object.push = $root.centrifugal.centrifuge.protocol.Push.toObject(message.push, options);
                    if (message.connect != null && message.hasOwnProperty("connect"))
                        object.connect = $root.centrifugal.centrifuge.protocol.ConnectResult.toObject(message.connect, options);
                    if (message.subscribe != null && message.hasOwnProperty("subscribe"))
                        object.subscribe = $root.centrifugal.centrifuge.protocol.SubscribeResult.toObject(message.subscribe, options);
                    if (message.unsubscribe != null && message.hasOwnProperty("unsubscribe"))
                        object.unsubscribe = $root.centrifugal.centrifuge.protocol.UnsubscribeResult.toObject(message.unsubscribe, options);
                    if (message.publish != null && message.hasOwnProperty("publish"))
                        object.publish = $root.centrifugal.centrifuge.protocol.PublishResult.toObject(message.publish, options);
                    if (message.presence != null && message.hasOwnProperty("presence"))
                        object.presence = $root.centrifugal.centrifuge.protocol.PresenceResult.toObject(message.presence, options);
                    if (message.presenceStats != null && message.hasOwnProperty("presenceStats"))
                        object.presenceStats = $root.centrifugal.centrifuge.protocol.PresenceStatsResult.toObject(message.presenceStats, options);
                    if (message.history != null && message.hasOwnProperty("history"))
                        object.history = $root.centrifugal.centrifuge.protocol.HistoryResult.toObject(message.history, options);
                    if (message.ping != null && message.hasOwnProperty("ping"))
                        object.ping = $root.centrifugal.centrifuge.protocol.PingResult.toObject(message.ping, options);
                    if (message.rpc != null && message.hasOwnProperty("rpc"))
                        object.rpc = $root.centrifugal.centrifuge.protocol.RPCResult.toObject(message.rpc, options);
                    if (message.refresh != null && message.hasOwnProperty("refresh"))
                        object.refresh = $root.centrifugal.centrifuge.protocol.RefreshResult.toObject(message.refresh, options);
                    if (message.subRefresh != null && message.hasOwnProperty("subRefresh"))
                        object.subRefresh = $root.centrifugal.centrifuge.protocol.SubRefreshResult.toObject(message.subRefresh, options);
                    return object;
                };
            ...
            protocol.Push = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IPush=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Push} Push instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                Push.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                 ...
                 * @returns {centrifugal.centrifuge.protocol.Push} Push
                 */
                Push.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Push)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Push();
                    if (object.channel != null)
                        message.channel = String(object.channel);
                    if (object.pub != null) {
                        if (typeof object.pub !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Push.pub: object expected");
                        message.pub = $root.centrifugal.centrifuge.protocol.Publication.fromObject(object.pub);
                    }
                    if (object.join != null) {
                        if (typeof object.join !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Push.join: object expected");
                        message.join = $root.centrifugal.centrifuge.protocol.Join.fromObject(object.join);
                    }
                    if (object.leave != null) {
                        if (typeof object.leave !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Push.leave: object expected");
                        message.leave = $root.centrifugal.centrifuge.protocol.Leave.fromObject(object.leave);
                    }
                    if (object.unsubscribe != null) {
                        if (typeof object.unsubscribe !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Push.unsubscribe: object expected");
                        message.unsubscribe = $root.centrifugal.centrifuge.protocol.Unsubscribe.fromObject(object.unsubscribe);
                    }
                    if (object.message != null) {
                        if (typeof object.message !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Push.message: object expected");
                        message.message = $root.centrifugal.centrifuge.protocol.Message.fromObject(object.message);
                    }
                    if (object.subscribe != null) {
                        if (typeof object.subscribe !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Push.subscribe: object expected");
                        message.subscribe = $root.centrifugal.centrifuge.protocol.Subscribe.fromObject(object.subscribe);
                    }
                    if (object.connect != null) {
                        if (typeof object.connect !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Push.connect: object expected");
                        message.connect = $root.centrifugal.centrifuge.protocol.Connect.fromObject(object.connect);
                    }
                    if (object.disconnect != null) {
                        if (typeof object.disconnect !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Push.disconnect: object expected");
                        message.disconnect = $root.centrifugal.centrifuge.protocol.Disconnect.fromObject(object.disconnect);
                    }
                    if (object.refresh != null) {
                        if (typeof object.refresh !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Push.refresh: object expected");
                        message.refresh = $root.centrifugal.centrifuge.protocol.Refresh.fromObject(object.refresh);
                    }
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Push
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Push} message Push
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                Push.toObject = function toObject(message, options) {
                    if (!options)
                        options = {};
                    let object = {};
                    if (options.defaults) {
                    ...
                    if (message.pub != null && message.hasOwnProperty("pub"))
                        object.pub = $root.centrifugal.centrifuge.protocol.Publication.toObject(message.pub, options);
                    if (message.join != null && message.hasOwnProperty("join"))
                        object.join = $root.centrifugal.centrifuge.protocol.Join.toObject(message.join, options);
                    if (message.leave != null && message.hasOwnProperty("leave"))
                        object.leave = $root.centrifugal.centrifuge.protocol.Leave.toObject(message.leave, options);
                    if (message.unsubscribe != null && message.hasOwnProperty("unsubscribe"))
                        object.unsubscribe = $root.centrifugal.centrifuge.protocol.Unsubscribe.toObject(message.unsubscribe, options);
                    if (message.message != null && message.hasOwnProperty("message"))
                        object.message = $root.centrifugal.centrifuge.protocol.Message.toObject(message.message, options);
                    if (message.subscribe != null && message.hasOwnProperty("subscribe"))
                        object.subscribe = $root.centrifugal.centrifuge.protocol.Subscribe.toObject(message.subscribe, options);
                    if (message.connect != null && message.hasOwnProperty("connect"))
                        object.connect = $root.centrifugal.centrifuge.protocol.Connect.toObject(message.connect, options);
                    if (message.disconnect != null && message.hasOwnProperty("disconnect"))
                        object.disconnect = $root.centrifugal.centrifuge.protocol.Disconnect.toObject(message.disconnect, options);
                    if (message.refresh != null && message.hasOwnProperty("refresh"))
                        object.refresh = $root.centrifugal.centrifuge.protocol.Refresh.toObject(message.refresh, options);
                    return object;
                };
            ...
            protocol.ClientInfo = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IClientInfo=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.ClientInfo} ClientInfo instance
                 */
                ...
                ClientInfo.encode = function encode(message, writer) {
                    ...
                    if (message.connInfo != null && Object.hasOwnProperty.call(message, "connInfo"))
                        writer.uint32(/* id 3, wireType 2 =*/26).bytes(message.connInfo);
                    if (message.chanInfo != null && Object.hasOwnProperty.call(message, "chanInfo"))
                ...
                ClientInfo.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.ClientInfo)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.ClientInfo();
                    if (object.user != null)
                    ...
                    if (object.connInfo != null)
                        ...
                        else if (object.connInfo.length >= 0)
                    ...
                    if (object.chanInfo != null)
                        ...
                        else if (object.chanInfo.length >= 0)
                 ...
                 * @memberof centrifugal.centrifuge.protocol.ClientInfo
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ClientInfo} message ClientInfo
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                ClientInfo.toObject = function toObject(message, options) {
                    ...
                    if (options.defaults) {
                        ...
                        if (options.bytes === String)
                            ...
                            object.connInfo = [];
                            if (options.bytes !== Array)
                                object.connInfo = $util.newBuffer(object.connInfo);
                        }
                        if (options.bytes === String)
                            object.chanInfo = "";
                        else {
                            object.chanInfo = [];
                            if (options.bytes !== Array)
                                object.chanInfo = $util.newBuffer(object.chanInfo);
                        }
                    }
                    if (message.user != null && message.hasOwnProperty("user"))
            ...
            protocol.Publication = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IPublication=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Publication} Publication instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                Publication.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                Publication.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Publication)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Publication();
                    if (object.data != null)
                        if (typeof object.data === "string")
                            $util.base64.decode(object.data, message.data = $util.newBuffer($util.base64.length(object.data)), 0);
                        else if (object.data.length >= 0)
                    ...
                    if (object.info != null) {
                        if (typeof object.info !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Publication.info: object expected");
                        message.info = $root.centrifugal.centrifuge.protocol.ClientInfo.fromObject(object.info);
                    }
                    ...
                    if (object.tags) {
                        if (typeof object.tags !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Publication.tags: object expected");
                        message.tags = {};
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Publication
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Publication} message Publication
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                Publication.toObject = function toObject(message, options) {
                    ...
                    if (message.data != null && message.hasOwnProperty("data"))
                        object.data = options.bytes === String ? $util.base64.encode(message.data, 0, message.data.length) : options.bytes === Array ? Array.prototype.slice.call(message.data) : message.data;
                    if (message.info != null && message.hasOwnProperty("info"))
                        object.info = $root.centrifugal.centrifuge.protocol.ClientInfo.toObject(message.info, options);
                    if (message.offset != null && message.hasOwnProperty("offset"))
            ...
            protocol.Join = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IJoin=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Join} Join instance
                 */
                ...
                Join.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Join)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Join();
                    if (object.info != null) {
                        if (typeof object.info !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Join.info: object expected");
                        message.info = $root.centrifugal.centrifuge.protocol.ClientInfo.fromObject(object.info);
                    }
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Join
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Join} message Join
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.Leave = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ILeave=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Leave} Leave instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                Leave.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                Leave.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Leave)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Leave();
                    if (object.info != null) {
                        if (typeof object.info !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Leave.info: object expected");
                        message.info = $root.centrifugal.centrifuge.protocol.ClientInfo.fromObject(object.info);
                    }
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Leave
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Leave} message Leave
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.Unsubscribe = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IUnsubscribe=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Unsubscribe} Unsubscribe instance
                 */
                ...
                Unsubscribe.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Unsubscribe)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Unsubscribe();
                    if (object.code != null)
                        message.code = object.code >>> 0;
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Unsubscribe
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Unsubscribe} message Unsubscribe
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.Subscribe = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ISubscribe=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Subscribe} Subscribe instance
                 */
                ...
                Subscribe.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Subscribe)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Subscribe();
                    ...
                    if (object.offset != null)
                        if ($util.Long)
                            ...
                            message.offset = new $util.LongBits(object.offset.low >>> 0, object.offset.high >>> 0).toNumber(true);
                    if (object.positioned != null)
                        message.positioned = Boolean(object.positioned);
                    if (object.data != null)
                        if (typeof object.data === "string")
                            $util.base64.decode(object.data, message.data = $util.newBuffer($util.base64.length(object.data)), 0);
                        else if (object.data.length >= 0)
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Subscribe
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Subscribe} message Subscribe
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                Subscribe.toObject = function toObject(message, options) {
                    ...
                    if (message.offset != null && message.hasOwnProperty("offset"))
                        if (typeof message.offset === "number")
                            ...
                            object.offset = options.longs === String ? $util.Long.prototype.toString.call(message.offset) : options.longs === Number ? new $util.LongBits(message.offset.low >>> 0, message.offset.high >>> 0).toNumber(true) : message.offset;
                    if (message.positioned != null && message.hasOwnProperty("positioned"))
                        object.positioned = message.positioned;
                    if (message.data != null && message.hasOwnProperty("data"))
                        object.data = options.bytes === String ? $util.base64.encode(message.data, 0, message.data.length) : options.bytes === Array ? Array.prototype.slice.call(message.data) : message.data;
                    return object;
                };
            ...
            protocol.Message = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IMessage=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Message} Message instance
                 */
                ...
                Message.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Message)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Message();
                    if (object.data != null)
                        if (typeof object.data === "string")
                            $util.base64.decode(object.data, message.data = $util.newBuffer($util.base64.length(object.data)), 0);
                        else if (object.data.length >= 0)
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Message
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Message} message Message
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.Connect = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IConnect=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Connect} Connect instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                Connect.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                Connect.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Connect)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Connect();
                    if (object.client != null)
                        message.client = String(object.client);
                    ...
                    if (object.data != null)
                        if (typeof object.data === "string")
                            ...
                            message.data = object.data;
                    if (object.subs) {
                        if (typeof object.subs !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.Connect.subs: object expected");
                        message.subs = {};
                        for (let keys = Object.keys(object.subs), i = 0; i < keys.length; ++i) {
                            if (typeof object.subs[keys[i]] !== "object")
                                throw TypeError(".centrifugal.centrifuge.protocol.Connect.subs: object expected");
                            message.subs[keys[i]] = $root.centrifugal.centrifuge.protocol.SubscribeResult.fromObject(object.subs[keys[i]]);
                        }
                    }
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Connect
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Connect} message Connect
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                Connect.toObject = function toObject(message, options) {
                    ...
                    if (message.data != null && message.hasOwnProperty("data"))
                        object.data = options.bytes === String ? $util.base64.encode(message.data, 0, message.data.length) : options.bytes === Array ? Array.prototype.slice.call(message.data) : message.data;
                    let keys2;
                    if (message.subs && (keys2 = Object.keys(message.subs)).length) {
                        object.subs = {};
                        for (let j = 0; j < keys2.length; ++j)
                            object.subs[keys2[j]] = $root.centrifugal.centrifuge.protocol.SubscribeResult.toObject(message.subs[keys2[j]], options);
                    }
                    if (message.expires != null && message.hasOwnProperty("expires"))
            ...
            protocol.Disconnect = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IDisconnect=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Disconnect} Disconnect instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                Disconnect.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                Disconnect.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Disconnect)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Disconnect();
                    if (object.code != null)
                        message.code = object.code >>> 0;
                    if (object.reason != null)
                        message.reason = String(object.reason);
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Disconnect
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Disconnect} message Disconnect
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.Refresh = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IRefresh=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.Refresh} Refresh instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                Refresh.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                 ...
                 * @returns {centrifugal.centrifuge.protocol.Refresh} Refresh
                 */
                Refresh.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.Refresh)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.Refresh();
                    if (object.expires != null)
                        message.expires = Boolean(object.expires);
                    if (object.ttl != null)
                        message.ttl = object.ttl >>> 0;
                 ...
                 * @memberof centrifugal.centrifuge.protocol.Refresh
                 * @static
                 * @param {centrifugal.centrifuge.protocol.Refresh} message Refresh
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                Refresh.toObject = function toObject(message, options) {
                    if (!options)
                        options = {};
                    let object = {};
                    if (options.defaults) {
                 ...
                 * @returns {Object.<string,*>} JSON object
                 */
                Refresh.prototype.toJSON = function toJSON() {
                    return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                };
            ...
            protocol.ConnectRequest = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IConnectRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.ConnectRequest} ConnectRequest instance
                 */
                ...
                ConnectRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.ConnectRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.ConnectRequest();
                    ...
                    if (object.subs) {
                        if (typeof object.subs !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.ConnectRequest.subs: object expected");
                        message.subs = {};
                        for (let keys = Object.keys(object.subs), i = 0; i < keys.length; ++i) {
                            if (typeof object.subs[keys[i]] !== "object")
                                throw TypeError(".centrifugal.centrifuge.protocol.ConnectRequest.subs: object expected");
                            message.subs[keys[i]] = $root.centrifugal.centrifuge.protocol.SubscribeRequest.fromObject(object.subs[keys[i]]);
                        }
                    }
                    if (object.name != null)
                    ...
                    if (object.headers) {
                        if (typeof object.headers !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.ConnectRequest.headers: object expected");
                        message.headers = {};
                 ...
                 * @memberof centrifugal.centrifuge.protocol.ConnectRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ConnectRequest} message ConnectRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                ConnectRequest.toObject = function toObject(message, options) {
                    ...
                    if (message.subs && (keys2 = Object.keys(message.subs)).length) {
                        object.subs = {};
                        for (let j = 0; j < keys2.length; ++j)
                            object.subs[keys2[j]] = $root.centrifugal.centrifuge.protocol.SubscribeRequest.toObject(message.subs[keys2[j]], options);
                    }
                    if (message.name != null && message.hasOwnProperty("name"))
            ...
            protocol.ConnectResult = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IConnectResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.ConnectResult} ConnectResult instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                ConnectResult.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                ConnectResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.ConnectResult)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.ConnectResult();
                    if (object.client != null)
                        message.client = String(object.client);
                    if (object.version != null)
                        message.version = String(object.version);
                    ...
                    if (object.subs) {
                        if (typeof object.subs !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.ConnectResult.subs: object expected");
                        message.subs = {};
                        for (let keys = Object.keys(object.subs), i = 0; i < keys.length; ++i) {
                            if (typeof object.subs[keys[i]] !== "object")
                                throw TypeError(".centrifugal.centrifuge.protocol.ConnectResult.subs: object expected");
                 ...
                 * @memberof centrifugal.centrifuge.protocol.ConnectResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ConnectResult} message ConnectResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.RefreshRequest = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IRefreshRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.RefreshRequest} RefreshRequest instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                RefreshRequest.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                RefreshRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.RefreshRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.RefreshRequest();
                    if (object.token != null)
                        message.token = String(object.token);
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.RefreshRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.RefreshRequest} message RefreshRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.RefreshResult = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IRefreshResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.RefreshResult} RefreshResult instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                RefreshResult.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                RefreshResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.RefreshResult)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.RefreshResult();
                    if (object.client != null)
                        message.client = String(object.client);
                    if (object.version != null)
                        message.version = String(object.version);
                 ...
                 * @memberof centrifugal.centrifuge.protocol.RefreshResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.RefreshResult} message RefreshResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.SubscribeRequest = (function() {
                 ...
                 * @property {boolean|null} [joinLeave] SubscribeRequest joinLeave
                ...
                /**
                 * SubscribeRequest joinLeave.
                 * @member {boolean} joinLeave
                 * @memberof centrifugal.centrifuge.protocol.SubscribeRequest
                 * @instance
                 */
                SubscribeRequest.prototype.joinLeave = false;
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ISubscribeRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.SubscribeRequest} SubscribeRequest instance
                 */
                ...
                SubscribeRequest.encode = function encode(message, writer) {
                    ...
                    if (message.joinLeave != null && Object.hasOwnProperty.call(message, "joinLeave"))
                        writer.uint32(/* id 11, wireType 0 =*/88).bool(message.joinLeave);
                    if (message.delta != null && Object.hasOwnProperty.call(message, "delta"))
                ...
                SubscribeRequest.verify = function verify(message) {
                    ...
                    if (message.recoverable != null && message.hasOwnProperty("recoverable"))
                        if (typeof message.recoverable !== "boolean")
                            return "recoverable: boolean expected";
                    if (message.joinLeave != null && message.hasOwnProperty("joinLeave"))
                        if (typeof message.joinLeave !== "boolean")
                            return "joinLeave: boolean expected";
                    if (message.delta != null && message.hasOwnProperty("delta"))
                ...
                SubscribeRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.SubscribeRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.SubscribeRequest();
                    if (object.channel != null)
                        message.channel = String(object.channel);
                    if (object.token != null)
                        message.token = String(object.token);
                    ...
                    if (object.recoverable != null)
                        message.recoverable = Boolean(object.recoverable);
                    if (object.joinLeave != null)
                        message.joinLeave = Boolean(object.joinLeave);
                    if (object.delta != null)
                 ...
                 * @memberof centrifugal.centrifuge.protocol.SubscribeRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.SubscribeRequest} message SubscribeRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                SubscribeRequest.toObject = function toObject(message, options) {
                    ...
                    if (message.recoverable != null && message.hasOwnProperty("recoverable"))
                        object.recoverable = message.recoverable;
                    if (message.joinLeave != null && message.hasOwnProperty("joinLeave"))
                        object.joinLeave = message.joinLeave;
                    if (message.delta != null && message.hasOwnProperty("delta"))
                        object.delta = message.delta;
                    return object;
                };
            ...
            protocol.SubscribeResult = (function() {
                 ...
                 * @property {boolean|null} [wasRecovering] SubscribeResult wasRecovering
                ...
                /**
                 * SubscribeResult wasRecovering.
                 * @member {boolean} wasRecovering
                 * @memberof centrifugal.centrifuge.protocol.SubscribeResult
                 * @instance
                 */
                SubscribeResult.prototype.wasRecovering = false;
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ISubscribeResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.SubscribeResult} SubscribeResult instance
                 */
                ...
                SubscribeResult.encode = function encode(message, writer) {
                    ...
                    if (message.wasRecovering != null && Object.hasOwnProperty.call(message, "wasRecovering"))
                        writer.uint32(/* id 12, wireType 0 =*/96).bool(message.wasRecovering);
                    if (message.delta != null && Object.hasOwnProperty.call(message, "delta"))
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                SubscribeResult.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    ...
                    while (reader.pos < end) {
                        ...
                        case 12: {
                                message.wasRecovering = reader.bool();
                                break;
                            }
                        case 13: {
                                message.delta = reader.bool();
                ...
                SubscribeResult.verify = function verify(message) {
                    ...
                    if (message.data != null && message.hasOwnProperty("data"))
                        if (!(message.data && typeof message.data.length === "number" || $util.isString(message.data)))
                            return "data: buffer expected";
                    if (message.wasRecovering != null && message.hasOwnProperty("wasRecovering"))
                        if (typeof message.wasRecovering !== "boolean")
                            return "wasRecovering: boolean expected";
                    if (message.delta != null && message.hasOwnProperty("delta"))
                        if (typeof message.delta !== "boolean")
                            return "delta: boolean expected";
                    return null;
                ...
                SubscribeResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.SubscribeResult)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.SubscribeResult();
                    if (object.expires != null)
                        message.expires = Boolean(object.expires);
                    if (object.ttl != null)
                        message.ttl = object.ttl >>> 0;
                    ...
                    if (object.publications) {
                        if (!Array.isArray(object.publications))
                            throw TypeError(".centrifugal.centrifuge.protocol.SubscribeResult.publications: array expected");
                        message.publications = [];
                        for (let i = 0; i < object.publications.length; ++i) {
                            if (typeof object.publications[i] !== "object")
                                throw TypeError(".centrifugal.centrifuge.protocol.SubscribeResult.publications: object expected");
                            message.publications[i] = $root.centrifugal.centrifuge.protocol.Publication.fromObject(object.publications[i]);
                        }
                    }
                    ...
                    if (object.data != null)
                        if (typeof object.data === "string")
                            ...
                            message.data = object.data;
                    if (object.wasRecovering != null)
                        message.wasRecovering = Boolean(object.wasRecovering);
                    if (object.delta != null)
                        message.delta = Boolean(object.delta);
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.SubscribeResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.SubscribeResult} message SubscribeResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                SubscribeResult.toObject = function toObject(message, options) {
                    ...
                    if (message.publications && message.publications.length) {
                        object.publications = [];
                        for (let j = 0; j < message.publications.length; ++j)
                            object.publications[j] = $root.centrifugal.centrifuge.protocol.Publication.toObject(message.publications[j], options);
                    }
                    if (message.recovered != null && message.hasOwnProperty("recovered"))
                    ...
                    if (message.data != null && message.hasOwnProperty("data"))
                        object.data = options.bytes === String ? $util.base64.encode(message.data, 0, message.data.length) : options.bytes === Array ? Array.prototype.slice.call(message.data) : message.data;
                    if (message.wasRecovering != null && message.hasOwnProperty("wasRecovering"))
                        object.wasRecovering = message.wasRecovering;
                    if (message.delta != null && message.hasOwnProperty("delta"))
                        object.delta = message.delta;
                    return object;
                };
            ...
            protocol.SubRefreshRequest = (function() {
                ...
                /**
                 * Creates a new SubRefreshRequest instance using the specified properties.
                 * @function create
                 * @memberof centrifugal.centrifuge.protocol.SubRefreshRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ISubRefreshRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.SubRefreshRequest} SubRefreshRequest instance
                 */
                SubRefreshRequest.create = function create(properties) {
                    return new SubRefreshRequest(properties);
                };
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                SubRefreshRequest.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                /**
                 * Creates a SubRefreshRequest message from a plain object. Also converts values to their respective internal types.
                 * @function fromObject
                 * @memberof centrifugal.centrifuge.protocol.SubRefreshRequest
                 * @static
                 * @param {Object.<string,*>} object Plain object
                 * @returns {centrifugal.centrifuge.protocol.SubRefreshRequest} SubRefreshRequest
                 */
                SubRefreshRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.SubRefreshRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.SubRefreshRequest();
                    if (object.channel != null)
                        message.channel = String(object.channel);
                    if (object.token != null)
                        message.token = String(object.token);
                ...
                /**
                 * Creates a plain object from a SubRefreshRequest message. Also converts values to other types if specified.
                 * @function toObject
                 * @memberof centrifugal.centrifuge.protocol.SubRefreshRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.SubRefreshRequest} message SubRefreshRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                SubRefreshRequest.toObject = function toObject(message, options) {
                    if (!options)
                        options = {};
                    let object = {};
                    if (options.defaults) {
                ...
                /**
                 * Converts this SubRefreshRequest to JSON.
                 * @function toJSON
                 * @memberof centrifugal.centrifuge.protocol.SubRefreshRequest
                 * @instance
                 * @returns {Object.<string,*>} JSON object
                 */
                SubRefreshRequest.prototype.toJSON = function toJSON() {
                    return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                };
            ...
            protocol.SubRefreshResult = (function() {
                ...
                /**
                 * Creates a new SubRefreshResult instance using the specified properties.
                 * @function create
                 * @memberof centrifugal.centrifuge.protocol.SubRefreshResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ISubRefreshResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.SubRefreshResult} SubRefreshResult instance
                 */
                SubRefreshResult.create = function create(properties) {
                    return new SubRefreshResult(properties);
                };
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                SubRefreshResult.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                /**
                 * Creates a SubRefreshResult message from a plain object. Also converts values to their respective internal types.
                 * @function fromObject
                 * @memberof centrifugal.centrifuge.protocol.SubRefreshResult
                 * @static
                 * @param {Object.<string,*>} object Plain object
                 * @returns {centrifugal.centrifuge.protocol.SubRefreshResult} SubRefreshResult
                 */
                SubRefreshResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.SubRefreshResult)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.SubRefreshResult();
                    if (object.expires != null)
                        message.expires = Boolean(object.expires);
                    if (object.ttl != null)
                        message.ttl = object.ttl >>> 0;
                ...
                /**
                 * Creates a plain object from a SubRefreshResult message. Also converts values to other types if specified.
                 * @function toObject
                 * @memberof centrifugal.centrifuge.protocol.SubRefreshResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.SubRefreshResult} message SubRefreshResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                SubRefreshResult.toObject = function toObject(message, options) {
                    if (!options)
                        options = {};
                    let object = {};
                    if (options.defaults) {
                ...
                /**
                 * Converts this SubRefreshResult to JSON.
                 * @function toJSON
                 * @memberof centrifugal.centrifuge.protocol.SubRefreshResult
                 * @instance
                 * @returns {Object.<string,*>} JSON object
                 */
                SubRefreshResult.prototype.toJSON = function toJSON() {
                    return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
                };
            ...
            protocol.UnsubscribeRequest = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IUnsubscribeRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.UnsubscribeRequest} UnsubscribeRequest instance
                 */
                ...
                UnsubscribeRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.UnsubscribeRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.UnsubscribeRequest();
                    if (object.channel != null)
                        message.channel = String(object.channel);
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.UnsubscribeRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.UnsubscribeRequest} message UnsubscribeRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.UnsubscribeResult = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IUnsubscribeResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.UnsubscribeResult} UnsubscribeResult instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                UnsubscribeResult.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                UnsubscribeResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.UnsubscribeResult)
                        return object;
                    return new $root.centrifugal.centrifuge.protocol.UnsubscribeResult();
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.UnsubscribeResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.UnsubscribeResult} message UnsubscribeResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.PublishRequest = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IPublishRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.PublishRequest} PublishRequest instance
                 */
                ...
                PublishRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.PublishRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.PublishRequest();
                    if (object.channel != null)
                        message.channel = String(object.channel);
                    if (object.data != null)
                        if (typeof object.data === "string")
                 ...
                 * @memberof centrifugal.centrifuge.protocol.PublishRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.PublishRequest} message PublishRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.PublishResult = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IPublishResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.PublishResult} PublishResult instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                PublishResult.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                PublishResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.PublishResult)
                        return object;
                    return new $root.centrifugal.centrifuge.protocol.PublishResult();
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.PublishResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.PublishResult} message PublishResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.PresenceRequest = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IPresenceRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.PresenceRequest} PresenceRequest instance
                 */
                ...
                PresenceRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.PresenceRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.PresenceRequest();
                    if (object.channel != null)
                        message.channel = String(object.channel);
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.PresenceRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.PresenceRequest} message PresenceRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.PresenceResult = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IPresenceResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.PresenceResult} PresenceResult instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                PresenceResult.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                PresenceResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.PresenceResult)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.PresenceResult();
                    if (object.presence) {
                        if (typeof object.presence !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.PresenceResult.presence: object expected");
                        message.presence = {};
                        for (let keys = Object.keys(object.presence), i = 0; i < keys.length; ++i) {
                            if (typeof object.presence[keys[i]] !== "object")
                                throw TypeError(".centrifugal.centrifuge.protocol.PresenceResult.presence: object expected");
                            message.presence[keys[i]] = $root.centrifugal.centrifuge.protocol.ClientInfo.fromObject(object.presence[keys[i]]);
                        }
                    }
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.PresenceResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.PresenceResult} message PresenceResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                PresenceResult.toObject = function toObject(message, options) {
                    ...
                    if (message.presence && (keys2 = Object.keys(message.presence)).length) {
                        object.presence = {};
                        for (let j = 0; j < keys2.length; ++j)
                            object.presence[keys2[j]] = $root.centrifugal.centrifuge.protocol.ClientInfo.toObject(message.presence[keys2[j]], options);
                    }
                    return object;
                };
            ...
            protocol.PresenceStatsRequest = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IPresenceStatsRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.PresenceStatsRequest} PresenceStatsRequest instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                PresenceStatsRequest.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                PresenceStatsRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.PresenceStatsRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.PresenceStatsRequest();
                    if (object.channel != null)
                        message.channel = String(object.channel);
                    return message;
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.PresenceStatsRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.PresenceStatsRequest} message PresenceStatsRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.PresenceStatsResult = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IPresenceStatsResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.PresenceStatsResult} PresenceStatsResult instance
                 */
                ...
                PresenceStatsResult.encode = function encode(message, writer) {
                    ...
                    if (message.numUsers != null && Object.hasOwnProperty.call(message, "numUsers"))
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                PresenceStatsResult.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                PresenceStatsResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.PresenceStatsResult)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.PresenceStatsResult();
                 ...
                 * @memberof centrifugal.centrifuge.protocol.PresenceStatsResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.PresenceStatsResult} message PresenceStatsResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.StreamPosition = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IStreamPosition=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.StreamPosition} StreamPosition instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                StreamPosition.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                StreamPosition.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.StreamPosition)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.StreamPosition();
                    if (object.offset != null)
                        if ($util.Long)
                            (message.offset = $util.Long.fromValue(object.offset)).unsigned = true;
                        else if (typeof object.offset === "string")
                 ...
                 * @memberof centrifugal.centrifuge.protocol.StreamPosition
                 * @static
                 * @param {centrifugal.centrifuge.protocol.StreamPosition} message StreamPosition
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.HistoryRequest = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IHistoryRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.HistoryRequest} HistoryRequest instance
                 */
                ...
                HistoryRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.HistoryRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.HistoryRequest();
                    if (object.channel != null)
                        message.channel = String(object.channel);
                    ...
                    if (object.since != null) {
                        if (typeof object.since !== "object")
                            throw TypeError(".centrifugal.centrifuge.protocol.HistoryRequest.since: object expected");
                        message.since = $root.centrifugal.centrifuge.protocol.StreamPosition.fromObject(object.since);
                    }
                 ...
                 * @memberof centrifugal.centrifuge.protocol.HistoryRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.HistoryRequest} message HistoryRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                HistoryRequest.toObject = function toObject(message, options) {
                    ...
                    if (message.since != null && message.hasOwnProperty("since"))
                        object.since = $root.centrifugal.centrifuge.protocol.StreamPosition.toObject(message.since, options);
                    if (message.reverse != null && message.hasOwnProperty("reverse"))
            ...
            protocol.HistoryResult = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IHistoryResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.HistoryResult} HistoryResult instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                HistoryResult.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                HistoryResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.HistoryResult)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.HistoryResult();
                    if (object.publications) {
                        if (!Array.isArray(object.publications))
                            throw TypeError(".centrifugal.centrifuge.protocol.HistoryResult.publications: array expected");
                        message.publications = [];
                        for (let i = 0; i < object.publications.length; ++i) {
                            if (typeof object.publications[i] !== "object")
                                throw TypeError(".centrifugal.centrifuge.protocol.HistoryResult.publications: object expected");
                            message.publications[i] = $root.centrifugal.centrifuge.protocol.Publication.fromObject(object.publications[i]);
                        }
                    }
                    if (object.epoch != null)
                 ...
                 * @memberof centrifugal.centrifuge.protocol.HistoryResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.HistoryResult} message HistoryResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.PingRequest = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IPingRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.PingRequest} PingRequest instance
                 */
                ...
                PingRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.PingRequest)
                        return object;
                    return new $root.centrifugal.centrifuge.protocol.PingRequest();
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.PingRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.PingRequest} message PingRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.PingResult = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IPingResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.PingResult} PingResult instance
                 */
                ...
                PingResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.PingResult)
                        return object;
                    return new $root.centrifugal.centrifuge.protocol.PingResult();
                };
                 ...
                 * @memberof centrifugal.centrifuge.protocol.PingResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.PingResult} message PingResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
                PingResult.toObject = function toObject() {
                    return {};
                };
            ...
            protocol.RPCRequest = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IRPCRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.RPCRequest} RPCRequest instance
                 */
                ...
                RPCRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.RPCRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.RPCRequest();
                    if (object.data != null)
                        if (typeof object.data === "string")
                            $util.base64.decode(object.data, message.data = $util.newBuffer($util.base64.length(object.data)), 0);
                        else if (object.data.length >= 0)
                 ...
                 * @memberof centrifugal.centrifuge.protocol.RPCRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.RPCRequest} message RPCRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.RPCResult = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.IRPCResult=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.RPCResult} RPCResult instance
                 */
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                RPCResult.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                ...
                RPCResult.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.RPCResult)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.RPCResult();
                    if (object.data != null)
                        if (typeof object.data === "string")
                            $util.base64.decode(object.data, message.data = $util.newBuffer($util.base64.length(object.data)), 0);
                        else if (object.data.length >= 0)
                 ...
                 * @memberof centrifugal.centrifuge.protocol.RPCResult
                 * @static
                 * @param {centrifugal.centrifuge.protocol.RPCResult} message RPCResult
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
            ...
            protocol.SendRequest = (function() {
                 ...
                 * @static
                 * @param {centrifugal.centrifuge.protocol.ISendRequest=} [properties] Properties to set
                 * @returns {centrifugal.centrifuge.protocol.SendRequest} SendRequest instance
                 */
                ...
                SendRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.centrifugal.centrifuge.protocol.SendRequest)
                        return object;
                    let message = new $root.centrifugal.centrifuge.protocol.SendRequest();
                    if (object.data != null)
                        if (typeof object.data === "string")
                            $util.base64.decode(object.data, message.data = $util.newBuffer($util.base64.length(object.data)), 0);
                        else if (object.data.length >= 0)
                 ...
                 * @memberof centrifugal.centrifuge.protocol.SendRequest
                 * @static
                 * @param {centrifugal.centrifuge.protocol.SendRequest} message SendRequest
                 * @param {$protobuf.IConversionOptions} [options] Conversion options
                 * @returns {Object.<string,*>} Plain object
                 */
